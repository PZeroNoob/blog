<section class="paginacion">
	<ul>
		...
		?>
		<!-- Mostrar el boton para retroceder una pagina -->
		...
		<!-- Crear un elemento li por cada pagina que tengamos -->
		<?php for ($i = 1; $i <= $numero_paginas; $i++): ?>
			<!-- Agregar la clase active en la pagina actual -->
		...
		<!-- Mostrar el boton para avanzar una pagina -->
